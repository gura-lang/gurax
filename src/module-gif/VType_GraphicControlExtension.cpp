...
${help.ComposePropertyHelp(GraphicControlExtension, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(GraphicControlExtension, `en)}

${help.ComposeMethodHelp(GraphicControlExtension, `en)}
)**";
