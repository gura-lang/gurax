...
${help.ComposePropertyHelp(SDL_DollarGestureEvent, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(SDL_DollarGestureEvent, `en)}

${help.ComposeMethodHelp(SDL_DollarGestureEvent, `en)}
)**";
