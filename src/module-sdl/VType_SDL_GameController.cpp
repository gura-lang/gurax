...
//-----------------------------------------------------------------------------
// sdl.SDL_GameController#MethodSkeleton(num1:Number, num2:Number)
Gurax_DeclareMethod(SDL_GameController, MethodSkeleton)
{
...
Gurax_ImplementMethod(SDL_GameController, MethodSkeleton)
{
	// Target
...
void VType_SDL_GameController::DoPrepare(Frame& frameOuter)
{
	...
	Assign(Gurax_CreateMethod(SDL_GameController, MethodSkeleton));
