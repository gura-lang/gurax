...
public:
	// Constructor
	explicit Value_SDL_AudioSpec(VType& vtype = VTYPE_SDL_AudioSpec) : Value_Object(vtype) {}
	explicit Value_SDL_AudioSpec(SDL_AudioSpec* entity, VType& vtype = VTYPE_SDL_AudioSpec) :
