...
//-----------------------------------------------------------------------------
// sdl.SDL_PixelFormat#MethodSkeleton(num1:Number, num2:Number)
Gurax_DeclareMethod(SDL_PixelFormat, MethodSkeleton)
{
...
Gurax_ImplementMethod(SDL_PixelFormat, MethodSkeleton)
{
	// Target
