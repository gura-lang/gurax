...
//-----------------------------------------------------------------------------
// sdl.SDL_HapticEffect#MethodSkeleton(num1:Number, num2:Number)
Gurax_DeclareMethod(SDL_HapticEffect, MethodSkeleton)
{
...
Gurax_ImplementMethod(SDL_HapticEffect, MethodSkeleton)
{
	// Target
...
void VType_SDL_HapticEffect::DoPrepare(Frame& frameOuter)
{
	...
	Assign(Gurax_CreateMethod(SDL_HapticEffect, MethodSkeleton));
