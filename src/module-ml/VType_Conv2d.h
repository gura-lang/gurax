...
public:
	static const SerialId serialId = 0x00000101;
public:
	VType_Conv2d() : VType(serialId) {}
	explicit VType_Conv2d(const Symbol* pSymbol) : VType(serialId) {}
	explicit VType_Conv2d(const char* name) : VType(name, serialId) {}
