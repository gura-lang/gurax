...
// MaxPool3d
//------------------------------------------------------------------------------
MaxPool3d::MaxPool3d(size_t nRowsKernel, size_t nColsKernel, size_t strideRow, size_t strideCol) : Gear(false),
	_nRowsKernel(nRowsKernel), _nColsKernel(nColsKernel), _strideRow(strideRow), _strideCol(strideCol)
{
}

void MaxPool3d::Initialize()
{
}

bool MaxPool3d::CalcSizeOut(size_t nRowsIn, size_t nColsIn, size_t* pnRowsOut, size_t* pnColsOut) const
{
...
bool MaxPool3d::EvalForward(Processor& processor, RefPtr<Array>& pArrayFwdOut, const Array& arrayFwdIn, const Controller& controller)
{
...
// MaxPool3dOwner
//------------------------------------------------------------------------------
void MaxPool3dOwner::Clear()
{
	for (MaxPool3d* pMaxPool3d : *this) MaxPool3d::Delete(pMaxPool3d);
	clear();
}
