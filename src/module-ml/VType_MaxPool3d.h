...
public:
	static const SerialId serialId = 0x00000107;
public:
	VType_MaxPool3d() : VType(serialId) {}
	explicit VType_MaxPool3d(const Symbol* pSymbol) : VType(serialId) {}
	explicit VType_MaxPool3d(const char* name) : VType(name, serialId) {}
