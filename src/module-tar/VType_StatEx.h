...
// VType_StatEx.h
//==============================================================================
#ifndef GURAX_MODULE_TAR_VTYPE_STATEX_H
#define GURAX_MODULE_TAR_VTYPE_STATEX_H
#include <gurax.h>
...
public:
	// Constructor
	Value_StatEx() = delete;
	explicit Value_StatEx(StatEx* pStatEx, VType& vtype = VTYPE_StatEx) : Value_Stat(pStatEx, vtype) {}
