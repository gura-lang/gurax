...
${help.ComposePropertyHelp(zip.bzip2, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(zip.bzip2, `en)}

${help.ComposeMethodHelp(zip.bzip2, `en)}
)""";

//-----------------------------------------------------------------------------
// Implementation of class property
//-----------------------------------------------------------------------------
// zip.bzip2.blockSize100k
