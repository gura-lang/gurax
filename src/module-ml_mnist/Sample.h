...
// Sample.h
//==============================================================================
#ifndef GURAX_MODULE_ML_MNIST_SAMPLE_H
#define GURAX_MODULE_ML_MNIST_SAMPLE_H
#include <gurax.h>
#include "SampleSet.h"
...
public:
	...
	Gurax_MemoryPoolAllocator("ml.mnist.Sample");
private:
...
public:
	...
	UInt32 GetLabel(size_t idx) const;
	UInt32 GetLabel() const { return GetLabel(_idx); }
