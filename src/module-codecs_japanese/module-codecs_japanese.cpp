...
public:
	...
	public:
		...
		virtual UShort DBCSToUTF16(UShort codeDBCS) { return CP932ToUTF16(codeDBCS); }
	};
	class Encoder : public Codec_DBCS::Encoder {
	public:
		inline Encoder(bool addcrFlag) : Codec_DBCS::Encoder(addcrFlag) {}
		virtual UShort UTF16ToDBCS(UShort codeUTF16) { return UTF16ToCP932(codeUTF16); }
	};
};
...
Gurax_ModulePrepare()
{
	...
	CodecFactory::Register(new CodecFactory_DBCS<Codec_CP932>("cp932"));
	return true;
}
