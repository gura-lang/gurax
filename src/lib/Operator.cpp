...
Operator* Operator::math_atan2		= new Operator(OpStyle::OpBinary,		OpType::math_atan2);
...
Operator* Operator::math_hypot		= new Operator(OpStyle::OpBinary,		OpType::math_hypot);
