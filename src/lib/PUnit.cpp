...
PUnit* PUnitFactory_Value::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Value<1, true>(_pValue.release());
		} else {
			_pPUnitCreated = new PUnit_Value<1, false>(_pValue.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Lookup::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Lookup<1, true>(_pSymbol);
		} else {
			_pPUnitCreated = new PUnit_Lookup<1, false>(_pSymbol);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_AssignToSymbol::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_AssignToSymbol<1, true>(_pSymbol);
		} else {
			_pPUnitCreated = new PUnit_AssignToSymbol<1, false>(_pSymbol);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_AssignToDeclArg::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_AssignToDeclArg<1, true>(_pDeclArg.release());
		} else {
			_pPUnitCreated = new PUnit_AssignToDeclArg<1, false>(_pDeclArg.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_AssignFunction::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_AssignFunction<1, true>(_pFunction.release());
		} else {
			_pPUnitCreated = new PUnit_AssignFunction<1, false>(_pFunction.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Cast::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Cast<1, true>(_vtype, _listVarFlag);
		} else {
			_pPUnitCreated = new PUnit_Cast<1, false>(_vtype, _listVarFlag);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_GenIterator::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_GenIterator<1, true>();
		} else {
			_pPUnitCreated = new PUnit_GenIterator<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_GenRangeIterator::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_GenRangeIterator<1, true>();
		} else {
			_pPUnitCreated = new PUnit_GenRangeIterator<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_GenCounterIterator::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_GenCounterIterator<1, true>();
		} else {
			_pPUnitCreated = new PUnit_GenCounterIterator<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_EvalIterator::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_EvalIterator<1, true>(_offset, _pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_EvalIterator<1, false>(_offset, _pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_UnaryOp::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_UnaryOp<1, true>(_pOperator);
		} else {
			_pPUnitCreated = new PUnit_UnaryOp<1, false>(_pOperator);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_BinaryOp::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_BinaryOp<1, true>(_pOperator);
		} else {
			_pPUnitCreated = new PUnit_BinaryOp<1, false>(_pOperator);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Import::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Import<1, true>(_pDottedSymbol.release(), _pSymbolList.release(), _mixInFlag);
		} else {
			_pPUnitCreated = new PUnit_Import<1, false>(_pDottedSymbol.release(), _pSymbolList.release(), _mixInFlag);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_CreateVType::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_CreateVType<1, true>();
		} else {
			_pPUnitCreated = new PUnit_CreateVType<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_CreateList::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_CreateList<1, true>(_sizeReserve);
		} else {
			_pPUnitCreated = new PUnit_CreateList<1, false>(_sizeReserve);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_ListElem::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (_xlistFlag) {
			if (discardValueFlag) {
				_pPUnitCreated = new PUnit_ListElem<1, true, true>(_offset);
			} else {
				_pPUnitCreated = new PUnit_ListElem<1, false, true>(_offset);
			}
		} else {
			if (discardValueFlag) {
				_pPUnitCreated = new PUnit_ListElem<1, true, false>(_offset);
			} else {
				_pPUnitCreated = new PUnit_ListElem<1, false, false>(_offset);
			}
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
...
PUnit* PUnitFactory_CreateDict::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_CreateDict<1, true>();
		} else {
			_pPUnitCreated = new PUnit_CreateDict<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_DictElem::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_DictElem<1, true>(_offset);
		} else {
			_pPUnitCreated = new PUnit_DictElem<1, false>(_offset);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Index::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Index<1, true>(_pAttr.release(), _sizeReserve);
		} else {
			_pPUnitCreated = new PUnit_Index<1, false>(_pAttr.release(), _sizeReserve);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_FeedIndex::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_FeedIndex<1, true>();
		} else {
			_pPUnitCreated = new PUnit_FeedIndex<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_IndexGet::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_IndexGet<1, true>();
		} else {
			_pPUnitCreated = new PUnit_IndexGet<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_IndexSet::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_IndexSet<1, true>();
		} else {
			_pPUnitCreated = new PUnit_IndexSet<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_PropGet::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_PropGet<1, true>(_pSymbol, _pAttr.release());
		} else {
			_pPUnitCreated = new PUnit_PropGet<1, false>(_pSymbol, _pAttr.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_PropSet::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_PropSet<1, true>(_pSymbol, _pAttr.release());
		} else {
			_pPUnitCreated = new PUnit_PropSet<1, false>(_pSymbol, _pAttr.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Member::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Member<1, true>(_pSymbol, _pAttr.release());
		} else {
			_pPUnitCreated = new PUnit_Member<1, false>(_pSymbol, _pAttr.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Argument::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Argument<1, true>(*_pAttr, _pExprOfBlock.release());
		} else {
			_pPUnitCreated = new PUnit_Argument<1, false>(*_pAttr, _pExprOfBlock.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_BeginArgSlot::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_BeginArgSlot<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_BeginArgSlot<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_EndArgSlot::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_EndArgSlot<1, true>();
		} else {
			_pPUnitCreated = new PUnit_EndArgSlot<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_EndArgSlotNamed::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_EndArgSlotNamed<1, true>();
		} else {
			_pPUnitCreated = new PUnit_EndArgSlotNamed<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Call::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Call<1, true>();
		} else {
			_pPUnitCreated = new PUnit_Call<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Jump::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Jump<1, true>(_pPUnitCont);
		} else {
			_pPUnitCreated = new PUnit_Jump<1, false>(_pPUnitCont);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_JumpIf::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_JumpIf<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_JumpIf<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_JumpIfNot::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_JumpIfNot<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_JumpIfNot<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_NilJumpIf::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_NilJumpIf<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_NilJumpIf<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_NilJumpIfNot::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_NilJumpIfNot<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_NilJumpIfNot<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_KeepJumpIf::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_KeepJumpIf<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_KeepJumpIf<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_KeepJumpIfNot::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_KeepJumpIfNot<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_KeepJumpIfNot<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_BeginTryBlock::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_BeginTryBlock<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_BeginTryBlock<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_EndTryBlock::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_EndTryBlock<1, true>(_pPUnitCont);
		} else {
			_pPUnitCreated = new PUnit_EndTryBlock<1, false>(_pPUnitCont);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_JumpIfNoCatch::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_JumpIfNoCatch<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_JumpIfNoCatch<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_JumpIfNoCatchAny::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_JumpIfNoCatchAny<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_JumpIfNoCatchAny<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_NilJumpIfNoCatch::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_NilJumpIfNoCatch<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_NilJumpIfNoCatch<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_NilJumpIfNoCatchAny::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_NilJumpIfNoCatchAny<1, true>(_pPUnitBranchDest);
		} else {
			_pPUnitCreated = new PUnit_NilJumpIfNoCatchAny<1, false>(_pPUnitBranchDest);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_BeginSequence::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_BeginSequence<1, true>(_pPUnitSentinel);
		} else {
			_pPUnitCreated = new PUnit_BeginSequence<1, false>(_pPUnitSentinel);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_EndSequence::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_EndSequence<1, true>();
		} else {
			_pPUnitCreated = new PUnit_EndSequence<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_DiscardValue::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_DiscardValue<1, true>();
		} else {
			_pPUnitCreated = new PUnit_DiscardValue<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_RemoveValue::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_RemoveValue<1, true>(_offset);
		} else {
			_pPUnitCreated = new PUnit_RemoveValue<1, false>(_offset);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_RemoveValues::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_RemoveValues<1, true>(_offset, _cnt);
		} else {
			_pPUnitCreated = new PUnit_RemoveValues<1, false>(_offset, _cnt);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Break::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (_branchDestFlag) {
			if (discardValueFlag) {
				_pPUnitCreated = new PUnit_Break<1, true, true>(_pPUnitMarked);
			} else {
				_pPUnitCreated = new PUnit_Break<1, false, true>(_pPUnitMarked);
			}
		} else {
			if (discardValueFlag) {
				_pPUnitCreated = new PUnit_Break<1, true, false>(_pPUnitMarked);
			} else {
				_pPUnitCreated = new PUnit_Break<1, false, false>(_pPUnitMarked);
			}
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
...
PUnit* PUnitFactory_Continue::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Continue<1, true>(_pPUnitOfLoop);
		} else {
			_pPUnitCreated = new PUnit_Continue<1, false>(_pPUnitOfLoop);
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Miscatch::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Miscatch<1, true>(_pValue.release());
		} else {
			_pPUnitCreated = new PUnit_Miscatch<1, false>(_pValue.release());
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_Return::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_Return<1, true>();
		} else {
			_pPUnitCreated = new PUnit_Return<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_PushFrame<T_Frame>::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_PushFrame<1, T_Frame, true>();
		} else {
			_pPUnitCreated = new PUnit_PushFrame<1, T_Frame, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_PushFrameFromStack::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_PushFrameFromStack<1, true>();
		} else {
			_pPUnitCreated = new PUnit_PushFrameFromStack<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_PopFrame::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_PopFrame<1, true>();
		} else {
			_pPUnitCreated = new PUnit_PopFrame<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
...
PUnit* PUnitFactory_NoOperation::Create(bool discardValueFlag)
{
	if (_pExprSrc) {
		if (discardValueFlag) {
			_pPUnitCreated = new PUnit_NoOperation<1, true>();
		} else {
			_pPUnitCreated = new PUnit_NoOperation<1, false>();
		}
		_pPUnitCreated->SetExprSrc(_pExprSrc.Reference());
	} else {
		if (discardValueFlag) {
