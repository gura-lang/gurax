...
// VType_PairSet.h
//==============================================================================
#ifndef GURAX_MODULE_ML_CIFAR_VTYPE_PAIRSET_H
#define GURAX_MODULE_ML_CIFAR_VTYPE_PAIRSET_H
#include <gurax.h>
#include "PairSet.h"
...
public:
	...
	explicit Value_PairSet(PairSet* pCifar, VType& vtype = VTYPE_PairSet) :
		Value_Object(vtype), _pPairSet(pCifar) {}
