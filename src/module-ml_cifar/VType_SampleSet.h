...
// VType_SampleSet.h
//==============================================================================
#ifndef GURAX_MODULE_ML_CIFAR_VTYPE_SampleSet_H
#define GURAX_MODULE_ML_CIFAR_VTYPE_SampleSet_H
#include <gurax.h>
#include "SampleSet.h"
...
public:
	...
	explicit Value_SampleSet(SampleSet* pCifar, VType& vtype = VTYPE_SampleSet) :
		Value_Object(vtype), _pSampleSet(pCifar) {}
