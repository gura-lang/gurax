...
Gurax_TesterEntry(SizeOf)
{
	...
	using PUnit_AssignMethod_ = PUnit_AssignMethod<0, false, false>;
	...
	using PUnit_MemberSet_Normal_ = PUnit_MemberSet_Normal<0, false, false>;
	PrintSizeOf(PUnit_MemberSet_Normal_);
	using PUnit_MemberGet_Normal_ = PUnit_MemberGet_Normal<0, false>;
	PrintSizeOf(PUnit_MemberGet_Normal_);
	using PUnit_MemberGet_MapAlong_ = PUnit_MemberGet_MapAlong<0, false>;
	PrintSizeOf(PUnit_MemberGet_MapAlong_);
	using PUnit_MemberGet_MapToList_ = PUnit_MemberGet_MapToList<0, false>;
	PrintSizeOf(PUnit_MemberGet_MapToList_);
	using PUnit_MemberGet_MapToIter_ = PUnit_MemberGet_MapToIter<0, false>;
