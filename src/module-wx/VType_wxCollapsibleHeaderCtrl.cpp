...
${help.ComposePropertyHelp(wxCollapsibleHeaderCtrl, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxCollapsibleHeaderCtrl, `en)}

${help.ComposeMethodHelp(wxCollapsibleHeaderCtrl, `en)}
)**";
