...
${help.ComposePropertyHelp(wxGridCornerHeaderRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCornerHeaderRenderer, `en)}

${help.ComposeMethodHelp(wxGridCornerHeaderRenderer, `en)}
)**";
