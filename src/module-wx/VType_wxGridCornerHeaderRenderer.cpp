...
${help.ComposePropertyHelp(wxGridCornerHeaderRenderer)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCornerHeaderRenderer)}

${help.ComposeMethodHelp(wxGridCornerHeaderRenderer)}
)**";
