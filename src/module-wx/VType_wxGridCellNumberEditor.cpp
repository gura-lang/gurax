...
${help.ComposePropertyHelp(wxGridCellNumberEditor, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellNumberEditor, `en)}

${help.ComposeMethodHelp(wxGridCellNumberEditor, `en)}
)**";
