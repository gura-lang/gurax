...
${help.ComposePropertyHelp(wxGenericProgressDialog, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGenericProgressDialog, `en)}

${help.ComposeMethodHelp(wxGenericProgressDialog, `en)}
)**";
