...
${help.ComposePropertyHelp(wxSysColourChangedEvent, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxSysColourChangedEvent, `en)}

${help.ComposeMethodHelp(wxSysColourChangedEvent, `en)}
)**";
