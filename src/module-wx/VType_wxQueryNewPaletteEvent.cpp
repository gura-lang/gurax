...
${help.ComposePropertyHelp(wxQueryNewPaletteEvent, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxQueryNewPaletteEvent, `en)}

${help.ComposeMethodHelp(wxQueryNewPaletteEvent, `en)}
)**";
