...
//------------------------------------------------------------------------------
// wx.AuiMDIChildFrame(parent as wx.AuiMDIParentFrame, winid as Number, title as String, pos? as wx.Point, size? as wx.Size, style? as Number, name? as String) {block?} {block?}
