...
public:
	...
	Value_wxStyledTextEvent(const wxEvent& entity, Value* pValueUserData, VType& vtype = VTYPE_wxStyledTextEvent) :
...
public:
	wxStyledTextEvent& GetEntity() {
		return reinterpret_cast<wxStyledTextEvent&>(Value_wxEvent::GetEntity());
	}
	const wxStyledTextEvent& GetEntity() const {
		return reinterpret_cast<const wxStyledTextEvent&>(Value_wxEvent::GetEntity());
	}
	wxStyledTextEvent* GetEntityPtr() {
		return reinterpret_cast<wxStyledTextEvent*>(Value_wxEvent::GetEntityPtr());
	}
	const wxStyledTextEvent* GetEntityPtr() const {
		return reinterpret_cast<const wxStyledTextEvent*>(Value_wxEvent::GetEntityPtr());
	}
public:
