...
${help.ComposePropertyHelp(wxGridCellFloatRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellFloatRenderer, `en)}

${help.ComposeMethodHelp(wxGridCellFloatRenderer, `en)}
)**";
