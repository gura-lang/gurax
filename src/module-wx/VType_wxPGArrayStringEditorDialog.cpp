...
${help.ComposePropertyHelp(wxPGArrayStringEditorDialog)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxPGArrayStringEditorDialog)}

${help.ComposeMethodHelp(wxPGArrayStringEditorDialog)}
)**";
