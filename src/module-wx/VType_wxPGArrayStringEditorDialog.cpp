...
${help.ComposePropertyHelp(wxPGArrayStringEditorDialog, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxPGArrayStringEditorDialog, `en)}

${help.ComposeMethodHelp(wxPGArrayStringEditorDialog, `en)}
)**";
