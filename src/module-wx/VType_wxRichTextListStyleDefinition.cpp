...
${help.ComposePropertyHelp(wxRichTextListStyleDefinition, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextListStyleDefinition, `en)}

${help.ComposeMethodHelp(wxRichTextListStyleDefinition, `en)}
)**";
