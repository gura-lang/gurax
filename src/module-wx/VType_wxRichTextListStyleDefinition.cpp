...
${help.ComposePropertyHelp(wxRichTextListStyleDefinition)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextListStyleDefinition)}

${help.ComposeMethodHelp(wxRichTextListStyleDefinition)}
)**";
