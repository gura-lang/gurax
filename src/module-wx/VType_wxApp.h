...
public:
	wxApp* GetEntityPtr() {
		return reinterpret_cast<wxApp*>(Value_wxEvtHandler::GetEntityPtr());
	}
	const wxApp* GetEntityPtr() const {
		return reinterpret_cast<const wxApp*>(Value_wxEvtHandler::GetEntityPtr());
	}
public:
