...
${help.ComposePropertyHelp(wxQueryLayoutInfoEvent, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxQueryLayoutInfoEvent, `en)}

${help.ComposeMethodHelp(wxQueryLayoutInfoEvent, `en)}
)**";
