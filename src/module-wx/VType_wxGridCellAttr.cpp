...
${help.ComposePropertyHelp(wxGridCellAttr, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellAttr, `en)}

${help.ComposeMethodHelp(wxGridCellAttr, `en)}
)**";
...
Gurax_ImplementMethodEx(wxGridCellAttr, GetEditor_gurax, processor_gurax, argument_gurax)
{
	...
	return argument_gurax.ReturnValue(processor_gurax, new Value_wxGridCellEditor(
		*pEntity_gurax->GetEditor(grid, row, col)));
}
...
Gurax_ImplementMethodEx(wxGridCellAttr, GetRenderer_gurax, processor_gurax, argument_gurax)
{
	...
	return argument_gurax.ReturnValue(processor_gurax, new Value_wxGridCellRenderer(
		pEntity_gurax->GetRenderer(grid, row, col)));
}
