...
public:
	...
	explicit Value_wxIconBundle(const wxObject& entity, VType& vtype = VTYPE_wxIconBundle) :
...
public:
	wxIconBundle& GetEntity() {
		return reinterpret_cast<wxIconBundle&>(Value_wxObject::GetEntity());
	}
	const wxIconBundle& GetEntity() const {
		return reinterpret_cast<const wxIconBundle&>(Value_wxObject::GetEntity());
	}
	wxIconBundle* GetEntityPtr() {
		return reinterpret_cast<wxIconBundle*>(Value_wxObject::GetEntityPtr());
	}
	const wxIconBundle* GetEntityPtr() const {
		return reinterpret_cast<const wxIconBundle*>(Value_wxObject::GetEntityPtr());
	}
public:
