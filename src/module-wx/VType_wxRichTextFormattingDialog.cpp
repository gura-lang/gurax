...
${help.ComposePropertyHelp(wxRichTextFormattingDialog, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextFormattingDialog, `en)}

${help.ComposeMethodHelp(wxRichTextFormattingDialog, `en)}
)**";
