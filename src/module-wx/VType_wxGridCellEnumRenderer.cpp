...
${help.ComposePropertyHelp(wxGridCellEnumRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellEnumRenderer, `en)}

${help.ComposeMethodHelp(wxGridCellEnumRenderer, `en)}
)**";
