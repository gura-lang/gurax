...
public:
	wxImageHandler& GetEntity() {
		return reinterpret_cast<wxImageHandler&>(Value_wxObject::GetEntity());
	}
	const wxImageHandler& GetEntity() const {
		return reinterpret_cast<const wxImageHandler&>(Value_wxObject::GetEntity());
	}
	wxImageHandler* GetEntityPtr() {
		return reinterpret_cast<wxImageHandler*>(Value_wxObject::GetEntityPtr());
	}
	const wxImageHandler* GetEntityPtr() const {
		return reinterpret_cast<const wxImageHandler*>(Value_wxObject::GetEntityPtr());
	}
public:
