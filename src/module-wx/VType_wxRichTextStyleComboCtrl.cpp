...
${help.ComposePropertyHelp(wxRichTextStyleComboCtrl, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextStyleComboCtrl, `en)}

${help.ComposeMethodHelp(wxRichTextStyleComboCtrl, `en)}
)**";
