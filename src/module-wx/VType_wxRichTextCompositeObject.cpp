...
${help.ComposePropertyHelp(wxRichTextCompositeObject)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextCompositeObject)}

${help.ComposeMethodHelp(wxRichTextCompositeObject)}
)**";
