...
${help.ComposePropertyHelp(wxRichTextCompositeObject, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextCompositeObject, `en)}

${help.ComposeMethodHelp(wxRichTextCompositeObject, `en)}
)**";
