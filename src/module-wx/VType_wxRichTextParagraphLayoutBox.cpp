...
${help.ComposePropertyHelp(wxRichTextParagraphLayoutBox)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextParagraphLayoutBox)}

${help.ComposeMethodHelp(wxRichTextParagraphLayoutBox)}
)**";
