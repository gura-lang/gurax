...
${help.ComposePropertyHelp(wxGridRowHeaderRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridRowHeaderRenderer, `en)}

${help.ComposeMethodHelp(wxGridRowHeaderRenderer, `en)}
)**";
