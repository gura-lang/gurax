...
${help.ComposePropertyHelp(wxNumericPropertyValidator, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxNumericPropertyValidator, `en)}

${help.ComposeMethodHelp(wxNumericPropertyValidator, `en)}
)**";
