...
${help.ComposePropertyHelp(wxSettableHeaderColumn, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxSettableHeaderColumn, `en)}

${help.ComposeMethodHelp(wxSettableHeaderColumn, `en)}
)**";
