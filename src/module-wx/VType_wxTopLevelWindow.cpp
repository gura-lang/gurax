...
${help.ComposePropertyHelp(wxTopLevelWindow, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxTopLevelWindow, `en)}

${help.ComposeMethodHelp(wxTopLevelWindow, `en)}
)**";
...
Gurax_DeclareConstructorAlias(TopLevelWindow_gurax, "TopLevelWindow")
{
	...
	AddHelp(
		Gurax_Symbol(en),
		"Creates an instance of wx.TopLevelWindow.");
}
