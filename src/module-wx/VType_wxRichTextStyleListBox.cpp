...
${help.ComposePropertyHelp(wxRichTextStyleListBox, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextStyleListBox, `en)}

${help.ComposeMethodHelp(wxRichTextStyleListBox, `en)}
)**";
