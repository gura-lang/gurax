...
${help.ComposePropertyHelp(wxGridCellChoiceEditor, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellChoiceEditor, `en)}

${help.ComposeMethodHelp(wxGridCellChoiceEditor, `en)}
)**";
