...
${help.ComposePropertyHelp(wx.GridCellChoiceEditor, `ja)}

# オペレータ

# キャスト

${help.ComposeConstructorHelp(wx.GridCellChoiceEditor, `ja)}

${help.ComposeMethodHelp(wx.GridCellChoiceEditor, `ja)}
)""";
