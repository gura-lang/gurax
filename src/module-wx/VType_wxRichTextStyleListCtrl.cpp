...
${help.ComposePropertyHelp(wxRichTextStyleListCtrl, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextStyleListCtrl, `en)}

${help.ComposeMethodHelp(wxRichTextStyleListCtrl, `en)}
)**";
