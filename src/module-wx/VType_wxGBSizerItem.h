...
public:
	wxGBSizerItem& GetEntity() {
		return reinterpret_cast<wxGBSizerItem&>(Value_wxObject::GetEntity());
	}
	const wxGBSizerItem& GetEntity() const {
		return reinterpret_cast<const wxGBSizerItem&>(Value_wxObject::GetEntity());
	}
	wxGBSizerItem* GetEntityPtr() {
		return reinterpret_cast<wxGBSizerItem*>(Value_wxObject::GetEntityPtr());
	}
	const wxGBSizerItem* GetEntityPtr() const {
		return reinterpret_cast<const wxGBSizerItem*>(Value_wxObject::GetEntityPtr());
	}
public:
