...
public:
	wxPen& GetEntity() {
		return reinterpret_cast<wxPen&>(Value_wxObject::GetEntity());
	}
	const wxPen& GetEntity() const {
		return reinterpret_cast<const wxPen&>(Value_wxObject::GetEntity());
	}
	wxPen* GetEntityPtr() {
		return reinterpret_cast<wxPen*>(Value_wxObject::GetEntityPtr());
	}
	const wxPen* GetEntityPtr() const {
		return reinterpret_cast<const wxPen*>(Value_wxObject::GetEntityPtr());
	}
public:
