...
public:
	...
	explicit Value_wxGridCellFloatEditor(const wxClientDataContainer& entity, VType& vtype = VTYPE_wxGridCellFloatEditor) :
...
public:
	wxGridCellFloatEditor& GetEntity() {
		return reinterpret_cast<wxGridCellFloatEditor&>(Value_wxClientDataContainer::GetEntity());
	}
	const wxGridCellFloatEditor& GetEntity() const {
		return reinterpret_cast<const wxGridCellFloatEditor&>(Value_wxClientDataContainer::GetEntity());
	}
	wxGridCellFloatEditor* GetEntityPtr() {
		return reinterpret_cast<wxGridCellFloatEditor*>(Value_wxClientDataContainer::GetEntityPtr());
	}
	const wxGridCellFloatEditor* GetEntityPtr() const {
		return reinterpret_cast<const wxGridCellFloatEditor*>(Value_wxClientDataContainer::GetEntityPtr());
	}
public:
