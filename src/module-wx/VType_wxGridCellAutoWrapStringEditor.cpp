...
${help.ComposePropertyHelp(wxGridCellAutoWrapStringEditor, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellAutoWrapStringEditor, `en)}

${help.ComposeMethodHelp(wxGridCellAutoWrapStringEditor, `en)}
)**";
