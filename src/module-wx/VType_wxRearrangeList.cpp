...
//------------------------------------------------------------------------------
// wx.RearrangeList(parent as wx.Window, id as Number, pos as wx.Point, size as wx.Size, order[] as Number, items[] as String, style? as Number, validator? as wx.Validator, name? as String) {block?} {block?}
