...
//------------------------------------------------------------------------------
// wx.FilePickerCtrl(parent as wx.Window, id as Number, path? as String, message? as String, wildcard? as String, pos? as wx.Point, size? as wx.Size, style? as Number, validator? as wx.Validator, name? as String) {block?} {block?}
