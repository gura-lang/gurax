...
${help.ComposePropertyHelp(wxGridColumnHeaderRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridColumnHeaderRenderer, `en)}

${help.ComposeMethodHelp(wxGridColumnHeaderRenderer, `en)}
)**";
