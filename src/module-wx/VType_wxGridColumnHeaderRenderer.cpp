...
${help.ComposePropertyHelp(wxGridColumnHeaderRenderer)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridColumnHeaderRenderer)}

${help.ComposeMethodHelp(wxGridColumnHeaderRenderer)}
)**";
