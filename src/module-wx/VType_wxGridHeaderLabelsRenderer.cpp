...
${help.ComposePropertyHelp(wxGridHeaderLabelsRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridHeaderLabelsRenderer, `en)}

${help.ComposeMethodHelp(wxGridHeaderLabelsRenderer, `en)}
)**";
