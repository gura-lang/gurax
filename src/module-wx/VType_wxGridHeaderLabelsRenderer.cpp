...
${help.ComposePropertyHelp(wxGridHeaderLabelsRenderer)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridHeaderLabelsRenderer)}

${help.ComposeMethodHelp(wxGridHeaderLabelsRenderer)}
)**";
