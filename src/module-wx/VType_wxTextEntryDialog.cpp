...
${help.ComposePropertyHelp(wxTextEntryDialog, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxTextEntryDialog, `en)}

${help.ComposeMethodHelp(wxTextEntryDialog, `en)}
)**";

//------------------------------------------------------------------------------
// Implementation of constructor
//------------------------------------------------------------------------------
// wx.TextEntryDialog(parent as wx.Window, message as String, caption? as String, value? as String, style? as Number, pos? as wx.Point) {block?}
