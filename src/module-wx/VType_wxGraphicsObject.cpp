...
${help.ComposePropertyHelp(wx.GraphicsObject, `ja)}

# オペレータ

# キャスト

${help.ComposeConstructorHelp(wx.GraphicsObject, `ja)}

${help.ComposeMethodHelp(wx.GraphicsObject, `ja)}
)""";
...
Gurax_ImplementMethodEx(wxGraphicsObject, GetRenderer_gurax, processor_gurax, argument_gurax)
{
	...
	// Function body
	return argument_gurax.ReturnValue(processor_gurax, new Value_wxGraphicsRenderer(pEntity_gurax->GetRenderer()));
}
