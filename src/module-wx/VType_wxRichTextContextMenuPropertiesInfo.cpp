...
${help.ComposePropertyHelp(wxRichTextContextMenuPropertiesInfo, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextContextMenuPropertiesInfo, `en)}

${help.ComposeMethodHelp(wxRichTextContextMenuPropertiesInfo, `en)}
)**";
