...
${help.ComposePropertyHelp(wxGridCellDateRenderer, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridCellDateRenderer, `en)}

${help.ComposeMethodHelp(wxGridCellDateRenderer, `en)}
)**";
