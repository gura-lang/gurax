...
${help.ComposePropertyHelp(wx.ScrolledWindow, `ja)}

# オペレータ

# キャスト

${help.ComposeConstructorHelp(wx.ScrolledWindow, `ja)}

${help.ComposeMethodHelp(wx.ScrolledWindow, `ja)}
)""";
...
Gurax_ImplementConstructorEx(ScrolledWindow_gurax, processor_gurax, argument_gurax)
{
	...
	wxString name = name_validFlag? wxString(args_gurax.PickString()) : "scrolledWindow";
	// Function body
