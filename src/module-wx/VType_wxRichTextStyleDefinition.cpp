...
${help.ComposePropertyHelp(wxRichTextStyleDefinition)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextStyleDefinition)}

${help.ComposeMethodHelp(wxRichTextStyleDefinition)}
)**";
