...
${help.ComposePropertyHelp(wxRichTextStyleDefinition, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextStyleDefinition, `en)}

${help.ComposeMethodHelp(wxRichTextStyleDefinition, `en)}
)**";
