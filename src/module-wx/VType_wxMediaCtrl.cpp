...
//------------------------------------------------------------------------------
// wx.MediaCtrl(parent as wx.Window, id as Number, fileName? as String, pos? as wx.Point, size? as wx.Size, style? as Number, szBackend? as String, validator? as wx.Validator, name? as String) {block?} {block?}
