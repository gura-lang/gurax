...
${help.ComposePropertyHelp(wx.StaticLine, `ja)}

# オペレータ

# キャスト

${help.ComposeConstructorHelp(wx.StaticLine, `ja)}

${help.ComposeMethodHelp(wx.StaticLine, `ja)}
)""";
...
Gurax_ImplementConstructorEx(StaticLine_gurax, processor_gurax, argument_gurax)
{
	...
	wxString name = name_validFlag? wxString(args_gurax.PickString()) : wxStaticLineNameStr;
	// Function body
