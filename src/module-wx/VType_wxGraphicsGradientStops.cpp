...
${help.ComposePropertyHelp(wxGraphicsGradientStops, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGraphicsGradientStops, `en)}

${help.ComposeMethodHelp(wxGraphicsGradientStops, `en)}
)**";
