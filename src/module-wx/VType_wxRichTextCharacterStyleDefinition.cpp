...
${help.ComposePropertyHelp(wxRichTextCharacterStyleDefinition)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextCharacterStyleDefinition)}

${help.ComposeMethodHelp(wxRichTextCharacterStyleDefinition)}
)**";
