...
${help.ComposePropertyHelp(wxRichTextCharacterStyleDefinition, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxRichTextCharacterStyleDefinition, `en)}

${help.ComposeMethodHelp(wxRichTextCharacterStyleDefinition, `en)}
)**";
