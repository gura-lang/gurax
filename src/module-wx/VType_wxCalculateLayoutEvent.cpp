...
${help.ComposePropertyHelp(wxCalculateLayoutEvent, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxCalculateLayoutEvent, `en)}

${help.ComposeMethodHelp(wxCalculateLayoutEvent, `en)}
)**";
