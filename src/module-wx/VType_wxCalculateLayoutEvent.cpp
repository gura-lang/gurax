...
${help.ComposePropertyHelp(wx.CalculateLayoutEvent, `ja)}

# オペレータ

# キャスト

${help.ComposeConstructorHelp(wx.CalculateLayoutEvent, `ja)}

${help.ComposeMethodHelp(wx.CalculateLayoutEvent, `ja)}
)**";
