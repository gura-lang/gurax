...
${help.ComposePropertyHelp(wxGridRowHeaderRendererDefault, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(wxGridRowHeaderRendererDefault, `en)}

${help.ComposeMethodHelp(wxGridRowHeaderRendererDefault, `en)}
)**";
