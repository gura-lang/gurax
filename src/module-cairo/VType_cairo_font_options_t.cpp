...
${help.ComposePropertyHelp(cairo_font_options_t, `en)}

# Operator

# Cast Operation

${help.ComposeConstructorHelp(cairo_font_options_t, `en)}

${help.ComposeMethodHelp(cairo_font_options_t, `en)}
)**";

//-----------------------------------------------------------------------------
// Implementation of method
//-----------------------------------------------------------------------------
// cairo.cairo_font_options_t#MethodSkeleton(num1:Number, num2:Number)
Gurax_DeclareMethod(cairo_font_options_t, MethodSkeleton)
{
...
Gurax_ImplementMethod(cairo_font_options_t, MethodSkeleton)
{
	// Target
...
//-----------------------------------------------------------------------------
// cairo.cairo_font_options_t#propSkeleton
Gurax_DeclareProperty_R(cairo_font_options_t, propSkeleton)
{
	Declare(VTYPE_Number, Flag::None);
	AddHelp(
		Gurax_Symbol(en),
...
Gurax_ImplementPropertyGetter(cairo_font_options_t, propSkeleton)
{
