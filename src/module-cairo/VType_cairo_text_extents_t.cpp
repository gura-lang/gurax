...
//-----------------------------------------------------------------------------
// cairo.cairo_text_extents_t#propSkeleton
Gurax_DeclareProperty_R(cairo_text_extents_t, propSkeleton)
{
	Declare(VTYPE_Number, Flag::None);
	AddHelp(
		Gurax_Symbol(en),
...
Gurax_ImplementPropertyGetter(cairo_text_extents_t, propSkeleton)
{
...
void VType_cairo_text_extents_t::DoPrepare(Frame& frameOuter)
{
	...
	Assign(Gurax_CreateProperty(cairo_text_extents_t, propSkeleton));
}
