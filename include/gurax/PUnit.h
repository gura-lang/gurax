...
protected:
	const PUnit* CalcNext(size_t bytes) const {
		return reinterpret_cast<const PUnit*>(reinterpret_cast<const char*>(this) + bytes);
	}
};
...
public:
	...
	virtual const PUnit* GetPUnitNext() const override { return CalcNext(sizeof(*this)); }
