...
public:
	void Add_Value(Value* pValue, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_Value(pValue, Expr::Reference(pExprSrc)));
	}
	void Add_Lookup(const Symbol* pSymbol, const Expr* pExprSrc) {
	...
	void Add_AssignToSymbol(const Symbol* pSymbol, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_AssignToSymbol(pSymbol, Expr::Reference(pExprSrc)));
	}
	void Add_AssignToDeclArg(DeclArg* pDeclArg, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_AssignToDeclArg(pDeclArg, Expr::Reference(pExprSrc)));
	}
	void Add_AssignFunction(Function* pFunction, const Expr* pExprSrc) {
	...
	void Add_Cast(const VType& vtype, DeclArg::Flags flags, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_Cast(vtype, flags, Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator(Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator_Range(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator_Range(Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator_Counter(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator_Counter(Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator_ForLister(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator_ForLister(Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator_for(Expr_Block* pExprOfBlock, DeclArgOwner* pDeclArgOwner, bool skipNilFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator_for(pExprOfBlock, pDeclArgOwner, skipNilFlag, Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator_while(Expr* pExprCriteria, Expr_Block* pExprOfBlock, bool skipNilFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator_while(pExprCriteria, pExprOfBlock, skipNilFlag, Expr::Reference(pExprSrc)));
	}
	void Add_GenIterator_repeat(Expr_Block* pExprOfBlock, bool finiteFlag, bool skipNilFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_GenIterator_repeat(pExprOfBlock, finiteFlag, skipNilFlag, Expr::Reference(pExprSrc)));
	}
	void Add_EvalIterator(size_t offset, bool raiseFlag, const Expr* pExprSrc) {
	...
	void Add_ForEach(size_t offset, DeclArgOwner* pDeclArgOwner, const Expr* pExprSrc) {
		const PUnit* pPUnitBranchDest = nullptr;
		SetFactory(new PUnitFactory_ForEach(offset, pDeclArgOwner, pPUnitBranchDest, Expr::Reference(pExprSrc)));
	}
	void Add_UnaryOp(const Operator* pOp, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_UnaryOp(pOp, Expr::Reference(pExprSrc)));
	}
	void Add_BinaryOp(const Operator* pOp, const Expr* pExprSrc) {
	...
	void Add_Import(DottedSymbol* pDottedSymbol, SymbolList* pSymbolList,
					bool binaryFlag, bool mixInFlag, bool overwriteFlag, bool symbolForModuleFlag, const Expr* pExprSrc) {
	...
	void Add_IndexSet(bool valueFirstFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_IndexSet(valueFirstFlag, Expr::Reference(pExprSrc)));
	}
	void Add_IndexOpApply(const Operator* pOp, bool valueFirstFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_IndexOpApply(pOp, valueFirstFlag, Expr::Reference(pExprSrc)));
	}
	void Add_MemberSet_Normal(const Symbol* pSymbol, Attribute* pAttr, bool valueFirstFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberSet_Normal(pSymbol, pAttr, valueFirstFlag, Expr::Reference(pExprSrc)));
	}
	void Add_MemberSet_Map(const Symbol* pSymbol, Attribute* pAttr, bool mapAssignedFlag, bool valueFirstFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberSet_Map(pSymbol, pAttr, mapAssignedFlag, valueFirstFlag, Expr::Reference(pExprSrc)));
	}
	void Add_MemberOpApply_Normal(const Symbol* pSymbol, Attribute* pAttr, const Operator* pOp, bool valueFirstFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberOpApply_Normal(pSymbol, pAttr, pOp, valueFirstFlag, Expr::Reference(pExprSrc)));
	}
	void Add_MemberOpApply_Map(const Symbol* pSymbol, Attribute* pAttr, const Operator* pOp, bool mapAssignedFlag, bool valueFirstFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberOpApply_Map(pSymbol, pAttr, pOp, mapAssignedFlag, valueFirstFlag, Expr::Reference(pExprSrc)));
	}
	void Add_MemberGet_Normal(const Symbol* pSymbol, Attribute* pAttr, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberGet_Normal(pSymbol, pAttr, Expr::Reference(pExprSrc)));
	}
	void Add_MemberGet_MapAlong(const Symbol* pSymbol, Attribute* pAttr, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberGet_MapAlong(pSymbol, pAttr, Expr::Reference(pExprSrc)));
	}
	void Add_MemberGet_MapToList(const Symbol* pSymbol, Attribute* pAttr, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberGet_MapToList(pSymbol, pAttr, Expr::Reference(pExprSrc)));
	}
	void Add_MemberGet_MapToIter(const Symbol* pSymbol, Attribute* pAttr, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_MemberGet_MapToIter(pSymbol, pAttr, Expr::Reference(pExprSrc)));
	}
	void Add_Argument(Attribute* pAttr, Expr_Block* pExprOfBlock, bool keepCarFlag, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_Argument(pAttr, pExprOfBlock, keepCarFlag, Expr::Reference(pExprSrc)));
	}
	void Add_ArgumentDelegation(Attribute* pAttr, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_ArgumentDelegation(pAttr, Expr::Reference(pExprSrc)));
	}
	void Add_BeginArgSlot(const Expr* pExprSrc) {
		const PUnit* pPUnitBranchDest = nullptr;
		SetFactory(new PUnitFactory_BeginArgSlot(pPUnitBranchDest, Expr::Reference(pExprSrc)));
	}
	void Add_EndArgSlot(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_EndArgSlot(Expr::Reference(pExprSrc)));
	}
	void Add_EndArgSlotExpand(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_EndArgSlotExpand(Expr::Reference(pExprSrc)));
	}
	void Add_BeginArgSlotNamed(const Symbol* pSymbol, Expr* pExprAssigned, const Expr* pExprSrc) {
		const PUnit* pPUnitBranchDest = nullptr;
		SetFactory(new PUnitFactory_BeginArgSlotNamed(
					   pSymbol, pExprAssigned, pPUnitBranchDest, Expr::Reference(pExprSrc)));
	}
	void Add_EndArgSlotNamed(const Expr* pExprSrc) {
	...
	void Add_JumpIf(PUnit::BranchMode branchMode, const Expr* pExprSrc) {
		const PUnit* pPUnitBranchDest = nullptr;
		SetFactory(new PUnitFactory_JumpIf(pPUnitBranchDest, branchMode, Expr::Reference(pExprSrc)));
	}
	void Add_JumpIfNot(PUnit::BranchMode branchMode, const Expr* pExprSrc) {
		const PUnit* pPUnitBranchDest = nullptr;
	...
	void Add_EndTryBlock(const Expr* pExprSrc) {
		const PUnit* pPUnitCont = nullptr;
		SetFactory(new PUnitFactory_EndTryBlock(pPUnitCont, Expr::Reference(pExprSrc)));
	}
	void Add_JumpIfNoCatch(PUnit::BranchMode branchMode, const Expr* pExprSrc) {
		const PUnit* pPUnitBranchDest = nullptr;
		SetFactory(new PUnitFactory_JumpIfNoCatch(pPUnitBranchDest, branchMode, Expr::Reference(pExprSrc)));
	}
	...
	void Add_EndSequence(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_EndSequence(Expr::Reference(pExprSrc)));
	}
	void Add_DiscardValue(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_DiscardValue(Expr::Reference(pExprSrc)));
	}
	void Add_RemoveValue(size_t offset, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_RemoveValue(offset, Expr::Reference(pExprSrc)));
	}
	void Add_RemoveValues(size_t offset, size_t cnt, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_RemoveValues(offset, cnt, Expr::Reference(pExprSrc)));
	}
	void Add_Break(const PUnit* pPUnitMarked, bool branchDestFlag, const Expr* pExprSrc) {
	...
	template<typename T_Frame> void Add_PushFrame(const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_PushFrame<T_Frame>(Expr::Reference(pExprSrc)));
	}
	void Add_PushFrameFromStack(const Expr* pExprSrc) {
	...
	void Add_NoOperation(const Expr* pExprSrc) {
	...
	// PUnit for Template
	void Add_TmplString(Template* pTmpl, const String& str, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_TmplString(pTmpl, str, Expr::Reference(pExprSrc)));
	}	
	void Add_TmplScript(Expr_TmplScript* pExprTmplScript, const Expr* pExprSrc) {
		SetFactory(new PUnitFactory_TmplScript(pExprTmplScript, Expr::Reference(pExprSrc)));
	}	
	void Add_TmplEmbedded(Template* pTmpl, const Expr* pExprSrc) {
