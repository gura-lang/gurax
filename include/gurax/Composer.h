...
public:
	...
	void Add_GenIterator_for(Expr_Block* pExprOfBlock, DeclArgOwner* pDeclArgOwner, bool skipNilFlag, const Expr* pExprSrc = nullptr) {
	...
	void Add_MemberSet_Map(const Symbol* pSymbol, Attribute* pAttr, bool mapAssignedFlag, bool valueFirstFlag, const Expr* pExprSrc = nullptr) {
	...
	void Add_MemberOpApply_Map(const Symbol* pSymbol, Attribute* pAttr, const Operator* pOp, bool mapAssignedFlag, bool valueFirstFlag, const Expr* pExprSrc = nullptr) {
