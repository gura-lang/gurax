...
public:
	...
	void Add_Jump(const Expr* pExprSrc, const PUnit* pPUnitCont);
	PUnit_Jump* AddF_Jump(const Expr* pExprSrc, const PUnit* pPUnitCont = nullptr);
	PUnit_JumpIf* AddF_JumpIf(const Expr* pExprSrc, const PUnit* pPUnitBranch = nullptr);
	PUnit_JumpIfNot* AddF_JumpIfNot(const Expr* pExprSrc, const PUnit* pPUnitBranch = nullptr);
	PUnit_NilJumpIf* AddF_NilJumpIf(const Expr* pExprSrc, const PUnit* pPUnitBranch = nullptr);
	PUnit_NilJumpIfNot* AddF_NilJumpIfNot(const Expr* pExprSrc, const PUnit* pPUnitBranch = nullptr);
	PUnit_ExitPoint* AddF_ExitPoint(const Expr* pExprSrc, const PUnit* pPUnitExit = nullptr);
