...
public: \
	virtual Value* EvalUnary(const Value* pValue) const; \
}; \
Value* OpEntry_##opType##_##typeName::EvalUnary(const Value* pValue) const
...
public: \
	virtual Value* EvalBinary(const Value* pValueL, const Value* pValueR) const; \
}; \
Value* OpEntry_##opType##_##typeNameL##_##typeNameR::EvalBinary(const Value* pValueL, const Value* pValueR) const
...
public:
	Value* EvalUnary(const Value* pValue) const;
	Value* EvalBinary(const Value* pValueL, const Value* pValueR) const;
public:
